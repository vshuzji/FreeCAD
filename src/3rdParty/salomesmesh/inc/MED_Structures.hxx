...
struct SMESH_EXPORT TNameInfo: virtual TBase
{
...
*/
struct SMESH_EXPORT TModeSwitchInfo: virtual TBase
{
...
struct SMESH_EXPORT TMeshInfo: virtual TNameInfo
{
...
struct SMESH_EXPORT TFamilyInfo: virtual TNameInfo
{
...
struct SMESH_EXPORT TElemInfo: virtual TBase
{
    PMeshInfo myMeshInfo; //!< A reference to corresponding MED Mesh
    //! Get a reference to corresponding MED Mesh
    const PMeshInfo& GetMeshInfo() const { return myMeshInfo;}
...
struct SMESH_EXPORT TPolygoneInfo:
                                    virtual TElemInfo
{
...
struct SMESH_EXPORT TPolyedreInfo:
                                    virtual TElemInfo
{
...
struct SMESH_EXPORT TFieldInfo:
                                 virtual TNameInfo
{
    PMeshInfo myMeshInfo; //!< A reference to corresponding MED Mesh
    //! Get a reference to corresponding MED Mesh
...
struct SMESH_EXPORT TTimeStampInfo:
                                     virtual TBase
{
...
struct SMESH_EXPORT TProfileInfo:
                                   virtual TNameInfo
{
...
struct SMESH_EXPORT TMeshValueBase:
                                     virtual TModeSwitchInfo
{
    TInt myNbElem;
    TInt myNbComp;
...
struct SMESH_EXPORT TTimeStampValueBase:
                                          virtual TModeSwitchInfo
{
...
PFloatTimeStampValue SMESH_EXPORT
...
PIntTimeStampValue SMESH_EXPORT
...
struct SMESH_EXPORT TGrilleInfo:
                                  virtual TModeSwitchInfo
{
