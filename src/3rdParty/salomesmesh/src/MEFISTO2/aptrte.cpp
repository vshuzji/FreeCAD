...
#ifdef WIN32
#if defined MEFISTO2_EXPORTS
#define MEFISTO2_EXPORT __declspec( dllexport )
#else
#define MEFISTO2_EXPORT __declspec( dllimport )
#endif
#else
#define MEFISTO2_EXPORT
#endif
...
{
// 声明导出的全局变量
MEFISTO2_EXPORT R aretemaxface_;
#ifdef WIN32
    #ifdef F2C_BUILD
        MEFISTO2_EXPORT R __stdcall
    #else
        MEFISTO2_EXPORT R __stdcall
    #endif
#endif
